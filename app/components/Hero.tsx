...
export default function Hero() {
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-white to-gray-100">

      {/* Soft Glow Background */}
      <motion.div
        animate={{ opacity: [0.2, 0.35, 0.2] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[70%] h-[70%] bg-gradient-to-r from-teal-300/40 via-blue-400/40 to-purple-300/40 blur-[120px] rounded-full pointer-events-none"
      />
      ...
      {/* Subtle overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-white/40 via-white/10 to-white/50 pointer-events-none" />

      {/* Center content */}
      <div className="relative z-20 flex flex-col items-center justify-center text-center px-6 max-w-5xl">

        {/* Frosted-Glass Apple Panel with Neon Aura */}
        <div className="relative">
          ...
          <div className="
            ...
            rounded-3xl blur-2xl opacity-40 
          " />
