      ...
      <div className="container mx-auto px-6 relative z-10 py-24">
        ...
        <div id="knowledge-hub" className="mb-48 scroll-mt-24 flex flex-col items-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
              <HubCard icon={<BookOpen className="text-emerald-400" />} title="The Blog" desc="Bioinformatics algorithms and troubleshooting." link="#" cta="Read Articles" />
              <HubCard icon={<Mail className="text-purple-400" />} title="Newsletter" desc="Weekly insights on Biology and AI integration." link="#" cta="Subscribe" />
              <HubCard icon={<Library className="text-pink-400" />} title="My Books" desc="Comprehensive e-books for single-cell analysis." link="#" cta="Browse" />
            </div>
        ...
        <div id="resources" className="mb-48 scroll-mt-24">
            <div className="bg-slate-900/40 border border-slate-700/50 rounded-3xl p-8 md:p-12 grid md:grid-cols-2 gap-12 items-center backdrop-blur-md shadow-2xl">
              <div className="space-y-8">
                <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight">Stop Googling Syntax. <br/><span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-cyan-400">Get the Ultimate Guide.</span></h2>
                {isDownloaded ? <div className="p-6 bg-green-500/10 text-green-300 rounded-xl font-bold border border-green-500/30">Download Started!</div> : 
                  <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                    ...
                    <button type="submit" className="px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold rounded-lg flex items-center gap-2 shadow-lg shadow-purple-900/20">Download PDF</button>
                  </form>
                }
              </div>
              <div className="relative rounded-xl overflow-hidden border border-white/10 shadow-2xl">
                <video autoPlay loop muted playsInline className="w-full opacity-80"><source src="/dna-loop.mp4" type="video/mp4" /></video>
                <div className="absolute top-[48%] left-1/2 -translate-x-1/2 -translate-y-1/2 bg-slate-900/90 text-purple-300 font-bold text-[11px] px-2 py-0.5 rounded border border-white/10 shadow-lg">Transcription Factors</div>
              </div>
            </div>
        ...
        <div id="youtube" className="scroll-mt-24 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-16">
            <TrackCard track="Track A: Beginner" title="Python for Biologists" icon={<Code2 size={120} />} color="text-cyan-400" hoverColor="hover:border-cyan-500/50" />
            <TrackCard track="Track B: Advanced" title="Multiomics Integration" icon={<Terminal size={120} />} color="text-purple-400" hoverColor="hover:border-purple-500/50" />
          </div>
          {/* Arrow now points to the About section to conclude the path */}
          <div className="flex flex-col items-center gap-3">
...
function TrackCard({ track, title, icon, color, hoverColor }: any) { 
  return ( 
