cat <<EOF > content/posts/12202025.md
---
...
Reduces gene space to a few informative axes.
\`\`\`python
...
Constructs a graph representation and visualizes it in 2D.
\`\`\`python
